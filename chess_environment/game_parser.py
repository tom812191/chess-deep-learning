...
class ChessPGNParser:
    """
    Utility to parse a PGN string with multiple games into canonical state representations
    """
...
class ChessDatabaseParser:
    """
    Utility to parse a tuple of rows, fetched from the database, into their canonical state representation
